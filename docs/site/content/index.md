...
<ul class="why-list">
  ...
  <li><strong>Per-user notifications.</strong> Assignments, comments, closures. Opt out per kind, or disable the whole system with <code>NOTIFICATIONS_ENABLED=false</code>.</li>
  <li><strong>Live web UI.</strong> SSE + Postgres <code>LISTEN/NOTIFY</code>. Changes appear as they land, no refresh.</li>
